...
typedef unsigned char ac_q_mode;
typedef unsigned char ac_o_mode;

#define AC_TRN 0
#define AC_RND 1
#define AC_TRN_ZERO 2
#define AC_RND_ZERO 3
#define AC_RND_INF 4
#define AC_RND_MIN_INF 5
#define AC_RND_CONV 6
#define AC_RND_CONV_ODD 7

#define AC_WRAP 0
#define AC_SAT 1
#define AC_SAT_ZERO 2
#define AC_SAT_SYM 3
